...
#    plotNode(U'leaf',(0.8,0.1),(0.3,0.8),decisionNode)
#    plt.show()
...
def main():
    ...
    lbls = deepcopy(labels)
    mytree=createTree(myDat,lbls)
    print(classify(mytree,labels,[1,0]))
    #createPlot(createTree(myDat,labels))
    #print(getNumLeafs(createTree(myDat,labels)))
    #print(getTreeDepth(createTree(myDat,labels)))
    #createPlot()
